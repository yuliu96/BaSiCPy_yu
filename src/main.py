...
bkg_te = tifffile.imread('D:/BaSiC/simulationstudy/simulatedimages/background/FITC_20x.tif')[0]
...
fi_seg = tifffile.imread("D:/BaSiC/simulationstudy/simulatedimages/movie/segmentation.tif")[:, :, :, channel]
fi_seg =  skimage.morphology.binary_dilation(fi_seg>0, np.ones((1, 11, 11)))
fi_distorted = io.loadmat("D:/BaSiC/simulationstudy/fi_distorted.mat")["fi_distorted"].transpose(2, 0, 1)
...
basic = BaSiC(get_darkfield=False,
              ...
              #smoothness_darkfield = 0.198053098926636,
              )
basic.autotune(fi_distorted)
# basic.fit(images = fi_distorted,
